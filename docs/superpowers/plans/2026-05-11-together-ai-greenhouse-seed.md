# Together AI Greenhouse Seed Source Plan
...
1. Add Together AI to the verified extra public sources seed test.
2. Add `https://boards.greenhouse.io/togetherai` as a Greenhouse extra source.
...
- Seed catalog includes Together AI's direct Greenhouse extra source.
